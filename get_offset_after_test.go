...
func Test_GetOffsetAfter(t *testing.T) {
	...
	foundOffset, found, err := GetOffsetAfter(testPath, 0, time.Date(2024, 01, 02, 12, 11, 10, 8, time.UTC))
	assert_noerror(t, err)
	assert_equal(t, true, found)
	assert_equal(t, 1, foundOffset)
}
...
func Test_GetOffsetAfter_empty(t *testing.T) {
	...
	foundOffset, found, err := GetOffsetAfter(testPath, 0, time.Date(2024, 01, 02, 12, 9, 10, 9, time.UTC))
	assert_noerror(t, err)
...
func Test_GetOffsetAfter_beyondNewest(t *testing.T) {
	...
	foundOffset, found, err := GetOffsetAfter(testPath, 0, time.Date(2024, 01, 02, 12, 19, 10, 9, time.UTC))
	assert_noerror(t, err)
	assert_equal(t, false, found)
	assert_equal(t, 0, foundOffset)
}
...
func Test_GetOffsetAfter_equalsOldest(t *testing.T) {
	...
	foundOffset, found, err := GetOffsetAfter(testPath, 0, time.Date(2024, 01, 02, 12, 13, 10, 9, time.UTC))
	assert_noerror(t, err)
	assert_equal(t, true, found)
...
func Test_GetOffsetAfter_equalsNewest(t *testing.T) {
	...
	foundOffset, found, err := GetOffsetAfter(testPath, 0, time.Date(2024, 01, 02, 12, 15, 10, 9, time.UTC))
	assert_noerror(t, err)
	assert_equal(t, true, found)
